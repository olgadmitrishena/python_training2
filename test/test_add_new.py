...
def test_add_new_contact(app):
    ...
    contact_list = Contact(first_name="q", middle_name="w", last_name="e", title="r", company="t", adress="y", workphone="u", mobile="i",
                       fax="p", e_mail="a", mailtwo="s", mailthree="d", homepage="f", address2="g", homeadress="h", notestwo="j", byear="k", ayear="l")
